        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
            if (!optionsBuilder.IsConfigured){
               // optionsBuilder.UseSqlServer("Data Source = (Localdb)\\MSSQLLocalDB; Initial Catalog = AplicacionEducativa_Equipo_1");//conexion a base de datos local
                optionsBuilder.UseSqlServer("Data Source=SQL8002.site4now.net;Initial Catalog=db_a8d4e8_dijaliyo001;User Id=db_a8d4e8_dijaliyo001_admin;Password=MISIONES-tic2022");//conexion a base de datos web
            }
        }
    }
}
